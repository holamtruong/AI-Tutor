"""Tien ich lay thong tin phien am va audio"""
...
async def fetch_dictionary_api(word: str) -> Any:
    """Goi API tu dien cong khai de lay du lieu"""
...
async def extract_ipa_and_audio(word: str) -> tuple[str, dict[str, str]]:
    """Trich xuat chuoi IPA va link audio tu API"""
    ...
    def _find_audio(suffix: str) -> str:
        """Tim link audio phu hop voi hau to giong doc"""
    ...
    if not us_audio and phonetics:
        # neu khong co audio us ro rang thi lay audio dau tien lam mac dinh
